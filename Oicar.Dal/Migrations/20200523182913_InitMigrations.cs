    ...
    public partial class InitMigrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2020, 5, 23, 20, 29, 12, 886, DateTimeKind.Local).AddTicks(4910), "admin@test.com", "Admin", "Ad", new DateTime(2020, 5, 23, 20, 29, 12, 898, DateTimeKind.Local).AddTicks(7800), "Admin!123" },
                    { 2, new DateTime(2020, 5, 23, 20, 29, 12, 899, DateTimeKind.Local).AddTicks(170), "test@test.com", "Test", "Testic", new DateTime(2020, 5, 23, 20, 29, 12, 899, DateTimeKind.Local).AddTicks(190), "Test!123" }
                });
        }
